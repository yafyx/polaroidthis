...
const PosterPreview = forwardRef<HTMLDivElement, PosterPreviewProps>(
  ({ movieData }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="w-full max-w-[386px] mx-auto relative group perspective"
      >
        <div className="relative transform preserve-3d">
          ...
          {isMovieSelected ? (
            ...
            <div className="bg-[#dddad3] px-[22px] py-[20.5px] shadow-md w-full relative z-10 select-none">
              <div className="flex flex-col h-full">
                {/* Empty Image Section */}
                <div className="relative w-full aspect-square bg-gray-100 flex items-center justify-center">
                  <div className="text-center p-6">
                    <p className="text-gray-500 mb-2">No Movie Selected</p>
